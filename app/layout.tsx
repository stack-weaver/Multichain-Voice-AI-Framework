...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <title>MultiChain AI Agent</title>
        <link rel="shortcut icon" href="/images/favicon.ico" />
        <meta
          name="description"
          content="Starter template showing how to use MultiChain AI Agent in Next.js projects. See source code and deploy your own at https://github.com/rustyneuron01/Multichain-AI-Agent-Library!"
        />
        <meta property="og:title" content="MultiChain AI Agent" />
        <meta
        ...
        <meta name="twitter:title" content="MultiChain AI Agent" />
        <meta
